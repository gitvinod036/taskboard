  ...
  return (
    <main className="workspace-shell">
      ...
      <section className="dashboard-grid" aria-label="Workspace shortcuts">
        ...
        {!isAdmin && <a className="dashboard-card" href="/my-tasks"><span className="card-icon" aria-hidden="true">02</span><strong>My tasks</strong><span>See the tasks you have claimed.</span></a>}
